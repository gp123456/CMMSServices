...
public interface DamageDao extends JpaRepository<Damage, Long>, JpaSpecificationExecutor<Damage> {
     ...
     * @throws java.lang.Exception
     */
    public List findByCreatedBetweenAndDepartmentAndDeletedOrderByCreatedDesc(Date from, Date to, Long department, Boolean deleted) throws Exception;
     ...
     * @throws java.lang.Exception
     */
    public List findByCreatedBetweenAndDepartmentInAndTypeInAndDeletedOrderByCreatedDesc(
            Date from,
            Date to,
            List department,
            List type,
     ...
     * @param from
     * @param to
     * @param department the list of departments of plant.
     * @param type the type parameter is delay
     * @param deleted the delete parameter is false
     * @return the db damages info or null of specific department
     * @throws java.lang.Exception
     */
     ...
     * @throws java.lang.Exception
     */
    public List findByCreatedBetweenAndDepartmentAndTypeAndDeletedOrderByCreatedDesc(Date from, Date to, Long department, Long type, Boolean deleted)
            throws Exception;
     ...
     * @throws java.lang.Exception
     */
    public List<Damage> findByCreatedBetweenAndMachineAndTypeAndDeletedOrderByCreatedDesc(Date from, Date to, Long machine, Long type, Boolean deleted)
            throws Exception;

    /**
     * Return the deleted damages having the passed departments of user.
     *
     * @param department the list of departments of specific user
     * @param deleted the delete parameter is false
     * @return the db damages info or null of specific machine
     * @throws java.lang.Exception
     */
     ...
     * @throws java.lang.Exception
     */
    public Long countByCreatedBetweenAndMachineAndTypeInAndDeleted(Date from, Date to, Long machine, List type, Boolean deleted) throws Exception;
     ...
     * @param from
     * @param to
     * @param department the list of machines of plant.
     * @param type the type of cause.
     * @param deleted the delete parameter is false
     * @return the db damages info or null of specific machine and type
     * @throws java.lang.Exception
     */
    public Long countByCreatedBetweenAndDepartmentInAndTypeInAndDeleted(Date from, Date to, List department, List type, Boolean deleted) throws Exception;
    ...
    @Query("SELECT d.cause, SUM(d.duration), d.machine FROM Damage d WHERE d.deleted = 0 AND d.department in :department AND d.type != :type AND "
            + "d.created BETWEEN :start AND :end GROUP BY d.cause")
    public List<Object[]> sumDurationByDepartmentInNoTypeShift(
    ...
    @Query("SELECT d.cause, SUM(d.duration), d.machine FROM Damage d WHERE d.deleted = 0 AND d.department in :department AND d.type = :type AND "
            + "d.created BETWEEN :start AND :end GROUP BY d.cause")
    public List<Object[]> sumDurationByDepartmentInTypeShift(
            @Param("department") List department,
            @Param("type") Long type,
            @Param("start") Date start,
            @Param("end") Date end) throws Exception;
     ...
     * @throws java.lang.Exception
     */
    @Query("SELECT SUM(d.duration) FROM Damage d WHERE d.deleted = 0 AND d.department in :department AND d.created BETWEEN :start AND :end")
    ...
    public List countMachinesByDepartmentInShift(
            @Param("department") List department,
            @Param("start") Date start,
            @Param("end") Date end) throws Exception;
     ...
     * @throws java.lang.Exception
     */
    @Query("SELECT d.cause, SUM(d.duration) FROM Damage d WHERE d.deleted = 0 AND d.machine = :machine AND d.type != :type AND d.created BETWEEN :start "
            + "AND :end GROUP BY d.cause")
    public List<Object[]> sumDurationByMachineNoTypeShift(
    ...
    @Query("SELECT d.cause, SUM(d.duration) FROM Damage d WHERE d.deleted = 0 AND d.machine = :machine AND d.type = :type AND d.created BETWEEN :start "
            + "AND :end GROUP BY d.cause")
    public List<Object[]> sumDurationByMachineTypeShift(
            @Param("machine") Long machine,
            @Param("type") Long type,
            @Param("start") Date start,
            @Param("end") Date end) throws Exception;
     ...
     * @throws java.lang.Exception
     */
    @Query("SELECT SUM(d.duration) FROM Damage d WHERE d.deleted = 0 AND d.machine = :machine AND d.created BETWEEN :start AND :end")
